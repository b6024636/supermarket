...
<html>
    ...
    <body>
        ...
        <div id="show-shift" class="content scaffold-show" role="main">
            ...
            <f:display bean="shift" />
            <g:form resource="${this.shift}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.shift}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
