...
<html>
    ...
    <body>
        ...
        <div id="show-teamleader" class="content scaffold-show" role="main">
            ...
            <f:display bean="teamleader" />
            <g:form resource="${this.teamleader}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.teamleader}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
